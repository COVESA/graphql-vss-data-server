...
void AddTypesToSchema(const std::shared_ptr<schema::Schema>& schema)
{
	...
	auto typeVehicle_Cabin_Door_Row1_Left_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Door_Row1_Left_Input)gql"sv, R"md(
All doors, including windows and switches
	...
	auto typeVehicle_Cabin_Door_Row1_Right_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Door_Row1_Right_Input)gql"sv, R"md(
All doors, including windows and switches
)md"sv);
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row1_Right_Input)gql"sv, typeVehicle_Cabin_Door_Row1_Right_Input);
	auto typeVehicle_Cabin_Door_Row2_Left_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Door_Row2_Left_Input)gql"sv, R"md(
All doors, including windows and switches
)md"sv);
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row2_Left_Input)gql"sv, typeVehicle_Cabin_Door_Row2_Left_Input);
	auto typeVehicle_Cabin_Door_Row2_Right_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Door_Row2_Right_Input)gql"sv, R"md(
All doors, including windows and switches
)md"sv);
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row2_Right_Input)gql"sv, typeVehicle_Cabin_Door_Row2_Right_Input);
	auto typeVehicle_Cabin_Seat_Row1_Pos1_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row1_Pos1_Input)gql"sv, R"md(
All seats.
)md"sv);
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row1_Pos1_Input)gql"sv, typeVehicle_Cabin_Seat_Row1_Pos1_Input);
	auto typeVehicle_Cabin_Seat_Row1_Pos2_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row1_Pos2_Input)gql"sv, R"md(
All seats.
)md"sv);
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row1_Pos2_Input)gql"sv, typeVehicle_Cabin_Seat_Row1_Pos2_Input);
	auto typeVehicle_Cabin_Seat_Row2_Pos1_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row2_Pos1_Input)gql"sv, R"md(
All seats.
)md"sv);
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row2_Pos1_Input)gql"sv, typeVehicle_Cabin_Seat_Row2_Pos1_Input);
	auto typeVehicle_Cabin_Seat_Row2_Pos2_Input = schema::InputObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row2_Pos2_Input)gql"sv, R"md(
All seats.
)md"sv);
	...
	auto typeVehicle = schema::ObjectType::Make(R"gql(Vehicle)gql"sv, R"md(
High-level vehicle data.
)md");
	schema->AddType(R"gql(Vehicle)gql"sv, typeVehicle);
	auto typeVehicle_Cabin = schema::ObjectType::Make(R"gql(Vehicle_Cabin)gql"sv, R"md(
All in-cabin components, including doors.
)md");
	schema->AddType(R"gql(Vehicle_Cabin)gql"sv, typeVehicle_Cabin);
	auto typeVehicle_CurrentLocation = schema::ObjectType::Make(R"gql(Vehicle_CurrentLocation)gql"sv, R"md(
The current latitude and longitude of the vehicle.
	...
	auto typeVehicle_Powertrain = schema::ObjectType::Make(R"gql(Vehicle_Powertrain)gql"sv, R"md(
Powertrain data for battery management, etc.
)md");
	schema->AddType(R"gql(Vehicle_Powertrain)gql"sv, typeVehicle_Powertrain);
	auto typeVehicle_Cabin_Door = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Door)gql"sv, R"md(
All doors, including windows and switches
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Door)gql"sv, typeVehicle_Cabin_Door);
	auto typeVehicle_Cabin_Seat = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Seat)gql"sv, R"md(
All seats.
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Seat)gql"sv, typeVehicle_Cabin_Seat);
	auto typeVehicle_Powertrain_CombustionEngine = schema::ObjectType::Make(R"gql(Vehicle_Powertrain_CombustionEngine)gql"sv, R"md(
Engine-specific data, stopping at the bell housing.
	...
	auto typeVehicle_Powertrain_FuelSystem = schema::ObjectType::Make(R"gql(Vehicle_Powertrain_FuelSystem)gql"sv, R"md(
Fuel system data.
)md");
	schema->AddType(R"gql(Vehicle_Powertrain_FuelSystem)gql"sv, typeVehicle_Powertrain_FuelSystem);
	auto typeVehicle_Powertrain_Transmission = schema::ObjectType::Make(R"gql(Vehicle_Powertrain_Transmission)gql"sv, R"md(
Transmission-specific data, stopping at the drive shafts.
	...
	auto typeVehicle_Cabin_Door_Row1 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Door_Row1)gql"sv, R"md(
All doors, including windows and switches
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row1)gql"sv, typeVehicle_Cabin_Door_Row1);
	auto typeVehicle_Cabin_Door_Row2 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Door_Row2)gql"sv, R"md(
All doors, including windows and switches
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row2)gql"sv, typeVehicle_Cabin_Door_Row2);
	auto typeVehicle_Cabin_Seat_Row1 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row1)gql"sv, R"md(
All seats.
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row1)gql"sv, typeVehicle_Cabin_Seat_Row1);
	auto typeVehicle_Cabin_Seat_Row2 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row2)gql"sv, R"md(
All seats.
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row2)gql"sv, typeVehicle_Cabin_Seat_Row2);
	auto typeVehicle_Powertrain_CombustionEngine_Engine = schema::ObjectType::Make(R"gql(Vehicle_Powertrain_CombustionEngine_Engine)gql"sv, R"md(
Engine signals
)md");
	schema->AddType(R"gql(Vehicle_Powertrain_CombustionEngine_Engine)gql"sv, typeVehicle_Powertrain_CombustionEngine_Engine);
	auto typeVehicle_Cabin_Door_Row1_Left = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Door_Row1_Left)gql"sv, R"md(
All doors, including windows and switches
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row1_Left)gql"sv, typeVehicle_Cabin_Door_Row1_Left);
	auto typeVehicle_Cabin_Door_Row1_Right = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Door_Row1_Right)gql"sv, R"md(
All doors, including windows and switches
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row1_Right)gql"sv, typeVehicle_Cabin_Door_Row1_Right);
	auto typeVehicle_Cabin_Door_Row2_Left = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Door_Row2_Left)gql"sv, R"md(
All doors, including windows and switches
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row2_Left)gql"sv, typeVehicle_Cabin_Door_Row2_Left);
	auto typeVehicle_Cabin_Door_Row2_Right = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Door_Row2_Right)gql"sv, R"md(
All doors, including windows and switches
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Door_Row2_Right)gql"sv, typeVehicle_Cabin_Door_Row2_Right);
	auto typeVehicle_Cabin_Seat_Row1_Pos1 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row1_Pos1)gql"sv, R"md(
All seats.
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row1_Pos1)gql"sv, typeVehicle_Cabin_Seat_Row1_Pos1);
	auto typeVehicle_Cabin_Seat_Row1_Pos2 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row1_Pos2)gql"sv, R"md(
All seats.
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row1_Pos2)gql"sv, typeVehicle_Cabin_Seat_Row1_Pos2);
	auto typeVehicle_Cabin_Seat_Row2_Pos1 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row2_Pos1)gql"sv, R"md(
All seats.
)md");
	schema->AddType(R"gql(Vehicle_Cabin_Seat_Row2_Pos1)gql"sv, typeVehicle_Cabin_Seat_Row2_Pos1);
	auto typeVehicle_Cabin_Seat_Row2_Pos2 = schema::ObjectType::Make(R"gql(Vehicle_Cabin_Seat_Row2_Pos2)gql"sv, R"md(
All seats.
)md");
	...
	typeSubscriptionDeliveryInterval->AddEnumValues({
		{ service::s_namesSubscriptionDeliveryInterval[static_cast<size_t>(vehicle::SubscriptionDeliveryInterval::DELIVERY_INTERVAL_5_SECONDS)], R"md(Rate limited: 5s between updates)md"sv, std::nullopt },
		{ service::s_namesSubscriptionDeliveryInterval[static_cast<size_t>(vehicle::SubscriptionDeliveryInterval::DELIVERY_INTERVAL_1_SECOND)], R"md(Rate limited: 1s between updates.)md"sv, std::nullopt },
		{ service::s_namesSubscriptionDeliveryInterval[static_cast<size_t>(vehicle::SubscriptionDeliveryInterval::REALTIME)], R"md(Get all the updates, no rate limit.)md"sv, std::nullopt }
	});
	...
	typeVehicle_Cabin->AddFields({
		...
		schema::Field::Make(R"gql(doorCount)gql"sv, R"md( Number of doors in vehicle )md"sv, std::nullopt, schema->LookupType("UInt8")),
	...
	typeVehicle_CurrentLocation->AddFields({
		schema::Field::Make(R"gql(altitude)gql"sv, R"md( Current elevation of the position. )md"sv, std::nullopt, schema->LookupType("Float")),
		schema::Field::Make(R"gql(latitude)gql"sv, R"md( Current latitude of vehicle. )md"sv, std::nullopt, schema->LookupType("Float")),
		schema::Field::Make(R"gql(longitude)gql"sv, R"md( Current longitude of vehicle. )md"sv, std::nullopt, schema->LookupType("Float"))
	});
	...
	typeVehicle_Powertrain_FuelSystem->AddFields({
		schema::Field::Make(R"gql(instantConsumption)gql"sv, R"md( Current consumption in liters per 100 km. )md"sv, std::nullopt, schema->LookupType("Float")),
		schema::Field::Make(R"gql(level)gql"sv, R"md( Level in fuel tank as percent of capacity. 0 = empty. 100 = full. )md"sv, std::nullopt, schema->LookupType("UInt8")),
		schema::Field::Make(R"gql(tankCapacity)gql"sv, R"md( Capacity of the fuel tank in liters )md"sv, std::nullopt, schema->LookupType("Float"))
	});
	typeVehicle_Powertrain_Transmission->AddFields({
		schema::Field::Make(R"gql(currentGear)gql"sv, R"md( The current gear. 0=Neutral, 1/2/..=Forward, -1/..=Reverse )md"sv, std::nullopt, schema->LookupType("Int8")),
		schema::Field::Make(R"gql(driveType)gql"sv, R"md( Drive type. )md"sv, std::nullopt, schema->LookupType("String"))
	});
	...
	typeVehicle_Powertrain_CombustionEngine_Engine->AddFields({
		schema::Field::Make(R"gql(speed)gql"sv, R"md( Engine speed measured as rotations per minute. )md"sv, std::nullopt, schema->LookupType("UInt16"))
	});
	typeVehicle_Cabin_Door_Row1_Left->AddFields({
		schema::Field::Make(R"gql(isOpen)gql"sv, R"md( Is door open or closed )md"sv, std::nullopt, schema->LookupType("Boolean"))
	});
	...
	typeVehicle_Cabin_Seat_Row1_Pos1->AddFields({
		schema::Field::Make(R"gql(heating)gql"sv, R"md( Seat cooling / heating. 0 = off. -100 = max cold. +100 = max heat. )md"sv, std::nullopt, schema->LookupType("Int8"))
	});
